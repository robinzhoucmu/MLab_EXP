...
log_files_set{5} = 'SensorLogs/wood_30_63.33_43.33_30_43.33_63.33/exp_08_18_1330_50.txt';
%H_tf = eye(4,4);
trans = [50;50;0];
H_tf = [eye(3,3), trans;
      0,0,0,1];
...
Tri_pts_set{2} = [0.01, 0.01, 0.13; 0.01,0.13,0.01];
Tri_pts_set{3} = [0.03    0.09    0.03; 0.03    0.03    0.09];
Tri_pts_set{4} = [0.01, 0.09,0.01;0.01,0.03,0.13];
Tri_pts_set{5} = [0.03, 0.06333, 0.04333; 0.03, 0.04333, 0.06333];
