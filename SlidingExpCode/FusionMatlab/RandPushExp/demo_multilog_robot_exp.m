...
[exp_record_set, sim_record_set] = ...
    MultiLogsEval(log_files_set, num_evals, Tri_pts_set, Tri_mass, Tri_com, mu_f_blk, Tri_pho, R_tool, H_tf, num_cors, r_facet, unit_scale);
toc;

save('blk_15_evals_exp_sim_compare.mat');
