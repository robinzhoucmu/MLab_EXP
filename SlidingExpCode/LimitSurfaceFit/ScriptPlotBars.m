...
file_name_fig = 'ExpRecord/Figures/BarPlots/3pts_noisy';
savefig(h, file_name_fig);
print(h, file_name_fig, '-deps');

% 3pts noise-free.
data = exp_record_3pts_noise_free.err_test;
[h] = PlotBarsWithErrors(data, group_name);
file_name_fig = 'ExpRecord/Figures/BarPlots/3pts_noise_free';
savefig(h, file_name_fig);
print(h, file_name_fig, '-deps');
...
[h] = PlotBarsWithErrors(data, group_name);
file_name_fig = 'ExpRecord/Figures/BarPlots/ring_noisy';
savefig(h, file_name_fig);
print(h, file_name_fig, '-deps');

% ring noise-free
data = exp_record_360_ring_noise_free.err_test;
[h] = PlotBarsWithErrors(data, group_name);
file_name_fig = 'ExpRecord/Figures/BarPlots/ring_noise_free';
savefig(h, file_name_fig);
print(h, file_name_fig, '-deps');
