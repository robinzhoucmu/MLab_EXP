 ...
 */
void publishROS(string topicName,ros::Publisher pub )
{
...
int main(int argc, char* argv[])
{
   ...
   //ros::Publisher mocapPub = nodeHandle.advertize<>("",100);
   //ros::Rate loop_rate(100);


   //While the program is still active and ROS running, publish the data
